    ...
    <div class="pl-3 pr-3">
        ...
        <div class="table-responsive mt-3">
            <table class="table table-striped">
                ...
                <thead>
                    <caption><td><a href="{{ route('devC-cate-add') }}" class="btn btn-success">Thêm mới</a></td></caption>
                    <tr>
                        <td>ID</td>
                        <td>Tên danh mục</td>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>26/04/2024</td>
                        <td><a href="{{ route('devC-cate-update') }}" class="btn btn-primary"><i class="bi bi-pencil-square"></i></a> <button class="btn btn-danger"><i class="bi bi-trash"></i></button></td>
                    </tr>
                </tbody>
